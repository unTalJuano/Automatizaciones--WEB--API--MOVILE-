...
public class Multiplicar implements Task {
	...
	public <T extends Actor> void performAs(T actor) {
		...
		actor.attemptsTo(Click.on(Target.the("Primer número")
				...
				Click.on(Home.SIMBOLO_MULTIPLICA),
    ...
    public static Multiplicar multiplicar() {
        return Tasks.instrumented(Multiplicar.class);
    }
    
    public Multiplicar losNumeros(int num1, int num2)
	{
		this.num1=num1;
		this.num2=num2;
		return this;
